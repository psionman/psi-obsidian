...
frame, txt.PREV,
'previous',
partial(self._previous_early_day, self.early_date, 1))
```
...
```python
        ...
        Notify.Notification.new(f"text copied: {text}").show()
```
