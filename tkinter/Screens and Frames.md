...
class Root():
    def __init__(self) -> None:
        ...
        displa
        y_icon(root, ICON_FILE, ignore_error=True)
...
from <application name>.constants import APP_TITLE
from <application name>.config import read_config
from <application name>.text import Text
...
class xxxFrame():
    ...
    def _button_frame(self, master: tk.Frame) -> tk.Frame:
        frame = ButtonFrame(master, tk.HORIZONTAL)
        frame.buttons = [
	        frame.icon_button('start', self._start_process, True),
